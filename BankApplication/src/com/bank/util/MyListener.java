	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps=con.prepareStatement("CREATE TABLE  NEWACCOUNT (ACCOUNTNO INTEGER PRIMARY KEY AUTO_INCREMENT,USERNAME VARCHAR(4000), PASSWORD VARCHAR(4000), REPASSWORD VARCHAR(4000), AMOUNT INTEGER, ADDRESS VARCHAR(4000), PHONE INTEGER )");
		ps.executeUpdate();
